...
- **বটম নেভিগেশন** — হোম / লাইভ টিভি / মুভি / ঘোষণা / সেটিংস (Material 3 আইকন সহ)
- **সাইডবার (ড্রয়ার)** — ঘোষণা, অ্যাডমিন প্যানেল, অ্যাপ শেয়ার, অ্যাপ সম্পর্কে
- **সেটিংস ট্যাব** — অ্যাডমিন প্যানেল, অ্যাপ শেয়ার, সংস্করণ তথ্য
...
app/
  src/main/
    java/com/beat/play/
      MainActivity.java          # সাইডবার (ড্রয়ার) + ৫ ট্যাব বটম নেভ (হোম/লাইভ/মুভি/ঘোষণা/সেটিংস)
      ...
      ui/                        # ফ্রাগমেন্ট (হোম + লিস্ট + সেটিংস + অ্যাডমিন)
      util/                      # SHA256, PlaylistParser (M3U), HttpUtil
    res/layout/                  # সব লেআউট (সাইডবার হেডার, সেটিংস সহ)
    res/menu/                    # বটম নেভ + ড্রয়ার মেনু
```
