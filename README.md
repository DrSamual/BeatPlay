...
**নতুন (অটো-সেটআপ):** `settings/adminPasswordHash` নোডটি আগে থেকে সেট না থাকলে, প্রথমবার অ্যাপ খুলে গিয়ার আইকনে ট্যাপ করলে নিজেই **"পাসওয়ার্ড সেট করুন"** মোড চলে আসবে — সেখানেই নতুন অ্যাডমিন পাসওয়ার্ড দিলে হ্যাশটি নিজে থেকে সেভ হয়ে যাবে। ম্যানুয়ালি কিছু করতে হবে না (শুধু রুলস `.write: true` থাকতে হবে)।

**পুরোনো (ম্যানুয়াল) পদ্ধতি:** হ্যাশটি নিজে বের করলে:
